...
static int __init interceptor_start(void) 
{
    ...
    */
	...
	ref_sys_read = (void *)sys_call_table[__NR_read]; // __NR_read is the macro for the syscall number of read()
                                                        // so if I want to get the reference for read syscall, I use sys_call_table[__NR_read]

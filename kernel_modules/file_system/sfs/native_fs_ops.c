...
static int read_sb_from_real_sfs(sfs_info_t *info, sfs_super_block_t *sb)
{
    ...
    printk(KERN_INFO "sfs: read_sb_from_real_sfs\n");
                ...
                byte4_t offset, void *buf, byte4_t len)
{
    ...
    printk(KERN_INFO "sfs: read_from_real_sfs\n");
...
static int write_to_real_sfs(sfs_info_t *info, byte4_t block, byte4_t offset, void *buf, byte4_t len)
{
    ...
    printk(KERN_INFO "sfs: write_to_real_sfs\n");
...
{
    printk(KERN_INFO "sfs: read_entry_from_real_sfs\n");
...
{
    printk(KERN_INFO "sfs: write_entry_to_real_sfs\n");
...
int init_browsing(sfs_info_t *info)
{
    ...
    printk(KERN_INFO "sfs: init_browsing\n");
...
int sfs_get_data_block(sfs_info_t *info)
{
    ...
    printk(KERN_INFO "sfs: sfs_get_data_block\n");
...
{
    printk(KERN_INFO "sfs: sfs_put_data_block\n");
...
/* This function is called only if the file doesn't exist */
{
    ...
    printk(KERN_INFO "sfs: sfs_create\n");
...
int sfs_lookup(sfs_info_t *info, char *fn, sfs_file_entry_t *fe)
{
    ...
    printk(KERN_INFO "sfs: sfs_lookup\n");
...
int sfs_remove(sfs_info_t *info, char *fn)
{
    ...
    printk(KERN_INFO "sfs: sfs_remove\n");
...
{
    printk(KERN_INFO "sfs: sfs_get_file_entry\n");
...
int sfs_update(sfs_info_t *info, int vfs_ino, int *size, int *timestamp, int *perms)
{
    ...
    printk(KERN_INFO "sfs: sfs_update\n");
...
{
    printk(KERN_INFO "sfs: sfs_update_file_entry\n");

/*
 * Provide the functionality to emulate the various 
 * partition tables on the DOR
 * See: https://www.opensourceforu.com/2012/01/device-drivers-partitions-hard-disk/
 * This is responsible for the partition information
 * like the number, type, size, etc shown using fdisk
 */
